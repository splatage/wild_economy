# wild_economy Phase 3 step 1 compile fix (`b71fb98a2cc6d66a991fc1c3fc9c1c39d8207a23`)

This hotfix corrects the missing `Locale` import in `AdminItemInspectorMenu`.
