# wild_economy Phase 2 pass 2 (`7005123f0de441eaea7854ae2ece880a796c0d55`)

This bundle contains complete replacement files for the second backend-focused Phase 2 admin pass.

Scope of this pass:
- improve rule-impact reporting with loss reporting and losing-rule/policy breakdowns
- make review buckets more actionable with subgroup counts and subgroup sample items
- strengthen `/shopadmin item <item_key>` with review-bucket membership and matched-but-lost rule visibility
