# wild_economy Phase 1 quality pass (`df00bcfb05c43680a6f28db30a11ae38f3d21b43`)

This bundle contains complete replacement files for the next narrow Phase 1 admin/catalog quality pass.

Scope of this pass:
- improve recipe graph coverage for repeated-choice/tag-heavy recipes
- complete wood-family fallback derivation for stripped inputs and stairs
- preserve semantic disable reasons over broad derivation-disable reasons when both result in `DISABLED`
