...
public final class MysqlEconomyLedgerRepository implements EconomyLedgerRepository {

    private final String ledgerTableName;

    public MysqlEconomyLedgerRepository(final DatabaseProvider databaseProvider, final String economyTablePrefix) {
